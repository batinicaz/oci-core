...
| <a name="input_private_subnets"></a> [private\_subnets](#input\_private\_subnets) | Details of private subnets (no internet access as always free doesn't include NGW) to create. Subnet Name --> CIDR | `map(string)` | <pre>{<br>  "private": "172.16.0.16/28"<br>}</pre> | no |
